        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="active">
                    ...
                    <ul class="nav flex-column collapse list-unstyled" id="homeSubmenu">
                        <li>
                ...
                <li>
                    <a href="#pageSubmenu" data_bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Pages</a>
