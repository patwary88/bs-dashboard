...
<div class="row">
  ...
  <div class="row">
    <div class="col input-group mb-2">
      <span class="input-group-text" id="inputGroup-sizing-sm">Name ( Bangla ) </span>
      <input type="text" id="txt_full_name_bangla" name="txt_full_name_bangla" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
    </div>
    <div class="col input-group mb-2">
    ...
    <div class="col input-group mb-2">
      <span class="input-group-text" id="inputGroup-sizing-default">Father Name ( Bangla )</span>
      <input type="text" id="txt_father_name_bangla" name="txt_father_name_bangla" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
    </div>
  </div>
  <div class="row">
    <div class="col input-group mb-2">
    ...
    <div class="col input-group mb-2">
      <span class="input-group-text" id="inputGroup-sizing-default">Mother Name ( Bangla )</span>
      <input type="text" id="txt_mother_name_bangla" name="txt_mother_name_bangla" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
    </div>
    <div class="col input-group mb-2">
